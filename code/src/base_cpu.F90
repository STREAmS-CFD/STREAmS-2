...
!
!
  subroutine bcswap_step_3_subroutine(nx,ny,nz,nv,ng,w_cpu,wbuf1r_cpu,wbuf2r_cpu,wbuf3r_cpu,wbuf4r_c&
  &pu,wbuf5r_cpu,wbuf6r_cpu,ileftx,ilefty,ileftz,irightx,irighty,irightz)
    integer :: nx, ny, nz, ng, nv
    real(rkind), dimension(1-ng:,1-ng:,1-ng:,1:) :: w_cpu
...
!
!
  subroutine bcswap_corner_step_3_subroutine(nx,ny,nz,nv,ng,w_cpu,wbuf1r_c_cpu,wbuf2r_c_cpu,wbuf3r_c&
  &_cpu,wbuf4r_c_cpu,ileftbottom,ilefttop,irightbottom,irighttop)
    integer :: nx, ny, nz, ng, nv
    real(rkind), dimension(1-ng:,1-ng:,1-ng:,1:) :: w_cpu
...
!
    associate(nx => self%nx, ny => self%ny, nz => self%nz, ng => self%ng, nv => self%nv, w_cpu => se&
    &lf%w_cpu, wbuf1s_c_cpu => self%wbuf1s_c_cpu, wbuf2s_c_cpu => self%wbuf2s_c_cpu, wbuf3s_c_cpu => self&
    &%wbuf3s_c_cpu, wbuf4s_c_cpu => self%wbuf4s_c_cpu, wbuf1r_c_cpu => self%wbuf1r_c_cpu, wbuf2r_c_cpu =>&
    & self%wbuf2r_c_cpu, wbuf3r_c_cpu => self%wbuf3r_c_cpu, wbuf4r_c_cpu => self%wbuf4r_c_cpu, ileftbotto&
...
!
      ...
      if(steps_(2)) then
        ...
        if (ileftbottom == nrank) then
          ...
          call mpi_sendrecv(wbuf1s_c_cpu,indc,mpi_prec,ileftbottom ,1, wbuf2r_c_cpu,indc,mpi_prec,ir&
          &ighttop ,1,mp_cart,istatus,iermpi)
          call mpi_sendrecv(wbuf2s_c_cpu,indc,mpi_prec,irighttop ,2, wbuf1r_c_cpu,indc,mpi_prec,ilef&
        ...
        if (ilefttop == nrank) then
          ...
          call mpi_sendrecv(wbuf3s_c_cpu,indc,mpi_prec,ilefttop ,3, wbuf4r_c_cpu,indc,mpi_prec,irigh&
          &tbottom,3,mp_cart,istatus,iermpi)
          call mpi_sendrecv(wbuf4s_c_cpu,indc,mpi_prec,irightbottom,4, wbuf3r_c_cpu,indc,mpi_prec,il&
...
!
    steps_ = .true. ; if(present(steps)) steps_ = steps
!
    associate(nx => self%nx, ny => self%ny, nz => self%nz, ng => self%ng, nv => self%nv, wbuf1s_c_cp&
    &u => self%wbuf1s_c_cpu, wbuf2s_c_cpu => self%wbuf2s_c_cpu, wbuf3s_c_cpu => self%wbuf3s_c_cpu, wbuf4s&
    &_c_cpu => self%wbuf4s_c_cpu, wbuf1r_c_cpu => self%wbuf1r_c_cpu, wbuf2r_c_cpu => self%wbuf2r_c_cpu, w&
    &buf3r_c_cpu => self%wbuf3r_c_cpu, wbuf4r_c_cpu => self%wbuf4r_c_cpu, ileftbottom => self%field%ileft&
...
!
    associate(nx => self%nx, ny => self%ny, nz => self%nz, ng => self%ng, nv => self%nv, w_cpu => se&
    &lf%w_cpu, wbuf1s_cpu => self%wbuf1s_cpu, wbuf2s_cpu => self%wbuf2s_cpu, wbuf3s_cpu => self%wbuf3s_cp&
    &u, wbuf4s_cpu => self%wbuf4s_cpu, wbuf5s_cpu => self%wbuf5s_cpu, wbuf6s_cpu => self%wbuf6s_cpu, wbuf&
    &1r_cpu => self%wbuf1r_cpu, wbuf2r_cpu => self%wbuf2r_cpu, wbuf3r_cpu => self%wbuf3r_cpu, wbuf4r_cpu &
    &=> self%wbuf4r_cpu, wbuf5r_cpu => self%wbuf5r_cpu, wbuf6r_cpu => self%wbuf6r_cpu, ileftx => self%fie&
...
!
    ...
    &cpu, wbuf2s_cpu => self%wbuf2s_cpu, wbuf3s_cpu => self%wbuf3s_cpu, wbuf4s_cpu => self%wbuf4s_cpu, wb&
    &uf5s_cpu => self%wbuf5s_cpu, wbuf6s_cpu => self%wbuf6s_cpu, wbuf1r_cpu => self%wbuf1r_cpu, wbuf2r_cp&
    &u => self%wbuf2r_cpu, wbuf3r_cpu => self%wbuf3r_cpu, wbuf4r_cpu => self%wbuf4r_cpu, wbuf5r_cpu => se&
    &lf%wbuf5r_cpu, wbuf6r_cpu => self%wbuf6r_cpu, ileftx => self%field%ileftx,irightx => self%field%irig&
