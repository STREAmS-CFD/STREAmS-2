module cgal_wrappers
    ...
    interface
        ...
        subroutine polyhedron_closest(ptree, query_x, query_y, query_z, near_x, near_y, near_z) bind(C,name="polyhedron_closest")
          ...
          real(c_rkind), value :: query_x, query_y, query_z
          real(c_rkind) :: near_x, near_y, near_z
        end subroutine
        ...
        subroutine polyhedron_closest_triangle(ptree, query_x, query_y, query_z, &
          ...
          type(c_ptr),value :: ptree
          real(c_rkind), value :: query_x, query_y, query_z
          real(c_rkind) :: tri_1_x, tri_1_y, tri_1_z
          real(c_rkind) :: tri_2_x, tri_2_y, tri_2_z
          real(c_rkind) :: tri_3_x, tri_3_y, tri_3_z
        end subroutine
        ...
        subroutine polyhedron_intersection(ptree, p1_x, p1_y, p1_z, p2_x, p2_y, p2_z, &
          ...
          logical(c_bool) :: res
          type(c_ptr),value :: ptree
          real(c_rkind), value :: p1_x, p1_y, p1_z, p2_x, p2_y, p2_z
          real(c_rkind) :: inters_x, inters_y, inters_z
        ...
        subroutine polyhedron_bbox(ptree, bmin_x, bmin_y, bmin_z, bmax_x, bmax_y, bmax_z) bind(C,name="polyhedron_bbox")
          import
          type(c_ptr),value :: ptree
          real(c_rkind) :: bmin_x, bmin_y, bmin_z, bmax_x, bmax_y, bmax_z
        end subroutine
    endinterface
contains
    ...
    function cgal_polyhedron_inside(ptree, query_x, query_y, query_z) result(is_inside)
        logical :: is_inside
        type(c_ptr),value :: ptree
        real(c_rkind) :: query_x, query_y, query_z
        ...
        type(c_ptr),value :: ptree
        real(c_rkind) :: p1_x, p1_y, p1_z, p2_x, p2_y, p2_z, inters_x, inters_y, inters_z
        integer(c_int) :: inters_type
